...
class xmb extends httpAsync {
  ...
  getTradeInRule(data) {
    return this.requestNew({
      url:
        '/tradeRule?cityId=' + data.cityId + '&activityId=' + data.activityId,
    })
  }
  ...
  getMyTradeList(data) {
    return this.requestNew({
      url:
        '/myTeadeList?activityId=' + data.activityId + '&userId=' + data.userId,
    })
  }
