...
import { httpAsync } from '../http/http-async.js'
class svip extends httpAsync {
  ...
  refureshGoods(data, type) {
    return this.request({
      url:
        '/v2.0/goods/allGoodsRefresh?cityId=' +
        data.cityId +
        '&activityId=' +
        data.activityId +
        '&pageSize=' +
  ...
  goodsDetail(data) {
    return this.request({
      url:
        '/v2.0/goods/goodsDetail?goodsId=' +
        data.goodsId +
        '&activity_type=' +
        data.activity_type,
    })
  ...
  getSelfOrderList(data) {
    return this.requestNew({
      url:
        '/svip/liberty/getUserOrderList?mobile=' +
        data.mobile +
        '&userId=' +
        data.userId +
        '&page=1&pageSize=100',
  ...
  getSelfOrderBrand(data) {
    return this.requestNew({
      url:
        '/svip/liberty/getOrderBrand?orderNum=' +
        data.orderNum +
        '&City=' +
        data.City,
    })
