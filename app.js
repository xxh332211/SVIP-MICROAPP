...
import 'umtrack-wx';
App({
  systemData: wx.getSystemInfoSync({
    success(res) {
      console.log(res)
    }
  }),
  onLaunch: function (options) {
    wx.setStorageSync('codePopup', true)

    if (!wx.getStorageSync('src') || wx.getStorageSync('src') == "运营小程序") {
  ...
  umengConfig: {
    appKey: '5f87bd5894846f78a972de90', //由友盟分配的APP_KEY
  ...
  //初始化
  initialize: function () {
    wx.removeStorageSync('isThisGoing')
